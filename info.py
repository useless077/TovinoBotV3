...
API_ID = int(environ('API_ID', '20389440'))
API_HASH = environ('API_HASH', 'a1a06a18eb9153e9dbd447cfd5da2457')
...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1001575521444').split()]
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://Tamilvc:Tamilvc@cluster0.euced.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
